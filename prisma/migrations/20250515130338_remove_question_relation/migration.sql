/*
  ...
  - You are about to drop the column `questionId` on the `Flashcard` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Flashcard" DROP COLUMN "questionId",
